// input.js
import { LEFT_UI, RIGHT_UI, GAME_X, GAME_WIDTH, SAFE, jumpBtn, restartBtn, startMenuBtn, centerFullBtn, resetTouch, toggleFullscreen } from './utils.js';
import { gameState, currentLevelIndex, totalPlayTime, loadLevel, setGameStateAndTimer } from './level.js';

export let touch = { left: false, right: false, jump: false };
    ...
    if (e.type === "touchstart") {
      for (let t of e.targetTouches) {
        ...
        if (x > startX && x < startX + startMenuBtn.w && y > startY && y < startY + startMenuBtn.h) {
          setGameStateAndTimer(0, 0.0); // Reset state timers through level controller
          loadLevel(0);
          return;
        }
